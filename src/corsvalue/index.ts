...
export class CorsOrigins extends CorsSettingValue {
  protected static errorMessage: string =
    "CorsOrigins.fromList() call values must contain at least 1 origin";
}

export class CorsMethods extends CorsSettingValue {
  protected static errorMessage: string =
    "CorsMethods.fromList() call values must contain at least 1 method";
}

// https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Headers
export class CorsHeaders extends CorsSettingValue {
  protected static errorMessage: string =
    "CorsHeaders.fromList() call values must contain at least 1 header";
}
