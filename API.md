...
| <code><a href="#@alma-cdk/openapix.ApiBaseProps.property.paths">paths</a></code> | <code>{[ key: string ]: <a href="#@alma-cdk/openapix.Methods">Methods</a>}</code> | Integrations for OpenApi Path definitions. |
...
- *Type:* {[ key: string ]: <a href="#@alma-cdk/openapix.Methods">Methods</a>}
...
| <code><a href="#@alma-cdk/openapix.ApiProps.property.paths">paths</a></code> | <code>{[ key: string ]: <a href="#@alma-cdk/openapix.Methods">Methods</a>}</code> | Integrations for OpenApi Path definitions. |
...
| <code><a href="#@alma-cdk/openapix.XAmazonApigatewayIntegration.property.requestParameters">requestParameters</a></code> | <code>{[ key: string ]: string}</code> | Specifies mappings from method request parameters to integration request parameters. |
| <code><a href="#@alma-cdk/openapix.XAmazonApigatewayIntegration.property.requestTemplates">requestTemplates</a></code> | <code>{[ key: string ]: string}</code> | Mapping templates for a request payload of specified MIME types. |
...
| <code><a href="#@alma-cdk/openapix.XAmazonApigatewayIntegrationResponse.property.responseParameters">responseParameters</a></code> | <code>{[ key: string ]: string}</code> | Specifies parameter mappings for the response. |
| <code><a href="#@alma-cdk/openapix.XAmazonApigatewayIntegrationResponse.property.responseTemplates">responseTemplates</a></code> | <code>{[ key: string ]: string}</code> | Specifies MIME type-specific mapping templates for the response’s payload. |
...
### Methods <a name="Methods" id="@alma-cdk/openapix.Methods"></a>
...
#### Initializers <a name="Initializers" id="@alma-cdk/openapix.Methods.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@alma-cdk/openapix.Methods.Initializer.parameter.methods">methods</a></code> | <code><a href="#@alma-cdk/openapix.IMethodIntegrations">IMethodIntegrations</a></code> | *No description.* |

---

##### `methods`<sup>Required</sup> <a name="methods" id="@alma-cdk/openapix.Methods.Initializer.parameter.methods"></a>

- *Type:* <a href="#@alma-cdk/openapix.IMethodIntegrations">IMethodIntegrations</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@alma-cdk/openapix.Methods.fetchAllIntegrations">fetchAllIntegrations</a></code> | Get all integrations. |
| <code><a href="#@alma-cdk/openapix.Methods.fetchIntegration">fetchIntegration</a></code> | Get an integration for a specific HTTP method. |
| <code><a href="#@alma-cdk/openapix.Methods.hasIntegration">hasIntegration</a></code> | Check if there is an integration for a specific HTTP method. |
| <code><a href="#@alma-cdk/openapix.Methods.removeIntegration">removeIntegration</a></code> | Remove integration from a specific HTTP method. |
| <code><a href="#@alma-cdk/openapix.Methods.setIntegration">setIntegration</a></code> | Add or update an integration for a specific HTTP method. |

---

##### `fetchAllIntegrations` <a name="fetchAllIntegrations" id="@alma-cdk/openapix.Methods.fetchAllIntegrations"></a>
...
##### `fetchIntegration` <a name="fetchIntegration" id="@alma-cdk/openapix.Methods.fetchIntegration"></a>

```typescript
public fetchIntegration(method: string): Integration
```

Get an integration for a specific HTTP method.

###### `method`<sup>Required</sup> <a name="method" id="@alma-cdk/openapix.Methods.fetchIntegration.parameter.method"></a>

- *Type:* string

---

##### `hasIntegration` <a name="hasIntegration" id="@alma-cdk/openapix.Methods.hasIntegration"></a>

```typescript
public hasIntegration(method: string): boolean
```

Check if there is an integration for a specific HTTP method.

###### `method`<sup>Required</sup> <a name="method" id="@alma-cdk/openapix.Methods.hasIntegration.parameter.method"></a>

- *Type:* string

---

##### `removeIntegration` <a name="removeIntegration" id="@alma-cdk/openapix.Methods.removeIntegration"></a>

```typescript
public removeIntegration(method: string): boolean
```

Remove integration from a specific HTTP method.

###### `method`<sup>Required</sup> <a name="method" id="@alma-cdk/openapix.Methods.removeIntegration.parameter.method"></a>

- *Type:* string

---

##### `setIntegration` <a name="setIntegration" id="@alma-cdk/openapix.Methods.setIntegration"></a>

```typescript
public setIntegration(method: string, integration: Integration): void
```

Add or update an integration for a specific HTTP method.

###### `method`<sup>Required</sup> <a name="method" id="@alma-cdk/openapix.Methods.setIntegration.parameter.method"></a>

- *Type:* string

---

###### `integration`<sup>Required</sup> <a name="integration" id="@alma-cdk/openapix.Methods.setIntegration.parameter.integration"></a>
...
### IMethodIntegrations <a name="IMethodIntegrations" id="@alma-cdk/openapix.IMethodIntegrations"></a>

- *Implemented By:* <a href="#@alma-cdk/openapix.IMethodIntegrations">IMethodIntegrations</a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.delete">delete</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.get">get</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.head">head</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.options">options</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.patch">patch</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.post">post</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.put">put</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |
| <code><a href="#@alma-cdk/openapix.IMethodIntegrations.property.trace">trace</a></code> | <code><a href="#@alma-cdk/openapix.Integration">Integration</a></code> | *No description.* |

---

##### `delete`<sup>Optional</sup> <a name="delete" id="@alma-cdk/openapix.IMethodIntegrations.property.delete"></a>
...
##### `get`<sup>Optional</sup> <a name="get" id="@alma-cdk/openapix.IMethodIntegrations.property.get"></a>
...
##### `head`<sup>Optional</sup> <a name="head" id="@alma-cdk/openapix.IMethodIntegrations.property.head"></a>
...
##### `options`<sup>Optional</sup> <a name="options" id="@alma-cdk/openapix.IMethodIntegrations.property.options"></a>
...
##### `patch`<sup>Optional</sup> <a name="patch" id="@alma-cdk/openapix.IMethodIntegrations.property.patch"></a>
...
##### `post`<sup>Optional</sup> <a name="post" id="@alma-cdk/openapix.IMethodIntegrations.property.post"></a>
...
##### `put`<sup>Optional</sup> <a name="put" id="@alma-cdk/openapix.IMethodIntegrations.property.put"></a>
...
##### `trace`<sup>Optional</sup> <a name="trace" id="@alma-cdk/openapix.IMethodIntegrations.property.trace"></a>
